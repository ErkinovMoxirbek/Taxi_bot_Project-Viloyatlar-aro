...
//        InlineKeyboardButton button2 = InlineKeyBoardUtil.button("Buxoro vil.", "region2/Buxoro vil.");
        InlineKeyboardButton button1 = InlineKeyBoardUtil.button("Farg'ona vil.", "region3/Farg'ona vil.");
        InlineKeyboardButton button2 = InlineKeyBoardUtil.button("Toshkent sh.", "region11/Toshkent sh.");
...
//    }
    ...
    public static InlineKeyboardMarkup getRegion1DistrictList(){
        ...
        InlineKeyboardButton button6 = InlineKeyBoardUtil.button("Farg'ona tumani", "district6/Farg'ona tumani");
        InlineKeyboardButton button7 = InlineKeyBoardUtil.button("Furqat tumani", "district7/Furqat tumani");
        InlineKeyboardButton button8 = InlineKeyBoardUtil.button("Marg'ilon shahri", "district8/Marg'ilon shahri");
    ...
    ///Tashkent shahri
    public static InlineKeyboardMarkup getRegion2DistrictList(){
        InlineKeyboardButton button1 = InlineKeyBoardUtil.button("Uchtepa tumani", "district1/Uchtepa tumani");
        InlineKeyboardButton button2 = InlineKeyBoardUtil.button("Bektemir tumani", "district2/Bektemir tumani");
        InlineKeyboardButton button3 = InlineKeyBoardUtil.button("Mirzo-Ulug'bek tumani", "district3/Mirzo-Ulug'bek tumani");
        InlineKeyboardButton button4 = InlineKeyBoardUtil.button("Mirobod tumani", "district4/Mirobod tumani");
        InlineKeyboardButton button5 = InlineKeyBoardUtil.button("Sergeli tumani", "district5/Sergeli tumani");
        InlineKeyboardButton button6 = InlineKeyBoardUtil.button("Olmazor tumani", "district6/Olmazor tumani");
        InlineKeyboardButton button7 = InlineKeyBoardUtil.button("Chilonzor tumani", "district7/Chilonzor tumani");
        InlineKeyboardButton button8 = InlineKeyBoardUtil.button("Shayxontohur tumani", "district8/Shayxontohur tumani");
        InlineKeyboardButton button9 = InlineKeyBoardUtil.button("Yunusobod tumani", "district9/Yunusobod tumani");
        InlineKeyboardButton button10 = InlineKeyBoardUtil.button("Yakkasaroy tumani", "district10/Yakkasaroy tumani");
        InlineKeyboardButton button11 = InlineKeyBoardUtil.button("Yashnobod tumani", "district11/Yashnobod tumani");
        InlineKeyboardButton button12 = InlineKeyBoardUtil.button("Yangixayot tumani", "district12/Yangixayot tumani");
        List<InlineKeyboardButton> row1 = new LinkedList<>();
        List<InlineKeyboardButton> row2 = new LinkedList<>();
        List<InlineKeyboardButton> row3 = new LinkedList<>();
        List<InlineKeyboardButton> row4 = new LinkedList<>();
    ...
    public static ReplyKeyboard continueNext() {
        List<InlineKeyboardButton> row = new LinkedList<>();
        InlineKeyboardButton button1 = InlineKeyBoardUtil.button("Davom etish", "continue");
        row.add(button1);
        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();
        List<List<InlineKeyboardButton>> rowList = new LinkedList<>();
        rowList.add(row);
